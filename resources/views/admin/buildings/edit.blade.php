    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buildings.update", [$building->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $building->description) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.building.fields.photo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.building.fields.photo_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($building) && $building->photo)
      var file = {!! json_encode($building->photo) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, '{{ $building->photo->getUrl('thumb') }}')
